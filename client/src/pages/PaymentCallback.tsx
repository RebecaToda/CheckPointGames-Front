...
export default function PaymentCallback() {
  ...
  const [status, setStatus] = useState<"success" | "pending" | "failure">(
    "pending"
  );
          ...
          <Card className="max-w-2xl mx-auto">
            ...
            <CardContent className="text-center space-y-4">
              <p className="text-muted-foreground">
                Seu pagamento foi processado com sucesso. As chaves dos jogos
                foram enviadas para seu email e estão disponíveis em "Meus
                Pedidos".
              </p>
        ...
        return (
          <Card className="max-w-2xl mx-auto">
            <CardHeader className="text-center">
              ...
              <CardTitle
                className="text-2xl"
                data-testid="text-payment-pending"
              >
                Pagamento Pendente
              </CardTitle>
            </CardHeader>
        ...
        return (
          <Card className="max-w-2xl mx-auto">
            <CardHeader className="text-center">
              ...
              <CardTitle
                className="text-2xl"
                data-testid="text-payment-failure"
              >
            ...
            <CardContent className="text-center space-y-4">
              <p className="text-muted-foreground">
                Não foi possível processar seu pagamento. Por favor, tente
                novamente ou escolha outro método de pagamento.
              </p>
              <div className="flex flex-col sm:flex-row gap-3 justify-center pt-4">
                <Button
                  onClick={() => setLocation("/")}
